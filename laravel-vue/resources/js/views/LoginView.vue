            ...
            <div class="bg-card border border-border rounded-xl p-6 shadow-sm">
                ...
                <div class="space-y-3 mb-6">
                    <button
                        ...
                        class="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-border rounded-lg hover:bg-accent transition-colors"
                    >
